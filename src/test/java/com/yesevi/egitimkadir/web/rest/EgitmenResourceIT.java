...
import com.yesevi.egitimkadir.repository.EgitmenRepository;
...
class EgitmenResourceIT {
    ...
    public static Egitmen createEntity(EntityManager em) {
        Egitmen egitmen = new Egitmen().adiSoyadi(DEFAULT_ADI_SOYADI).unvani(DEFAULT_UNVANI).puani(DEFAULT_PUANI);
        return egitmen;
    }
    ...
    public static Egitmen createUpdatedEntity(EntityManager em) {
        Egitmen egitmen = new Egitmen().adiSoyadi(UPDATED_ADI_SOYADI).unvani(UPDATED_UNVANI).puani(UPDATED_PUANI);
        return egitmen;
    }
    ...
    void putNewEgitmen() throws Exception {
        ...
        updatedEgitmen.adiSoyadi(UPDATED_ADI_SOYADI).unvani(UPDATED_UNVANI).puani(UPDATED_PUANI);
    ...
    void fullUpdateEgitmenWithPatch() throws Exception {
        ...
        partialUpdatedEgitmen.adiSoyadi(UPDATED_ADI_SOYADI).unvani(UPDATED_UNVANI).puani(UPDATED_PUANI);
