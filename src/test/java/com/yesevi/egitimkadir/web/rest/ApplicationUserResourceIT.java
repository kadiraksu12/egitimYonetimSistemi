...
class ApplicationUserResourceIT {
    ...
    private static final String DEFAULT_BIRIMI = "AAAAAAAAAA";
    private static final String UPDATED_BIRIMI = "BBBBBBBBBB";
    ...
    public static ApplicationUser createEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser().birimi(DEFAULT_BIRIMI);
    ...
    public static ApplicationUser createUpdatedEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser().birimi(UPDATED_BIRIMI);
        return applicationUser;
    }
    ...
    void createApplicationUser() throws Exception {
        ...
        assertThat(testApplicationUser.getBirimi()).isEqualTo(DEFAULT_BIRIMI);
    }
    ...
    void getAllApplicationUsers() throws Exception {
        ...
        restApplicationUserMockMvc
            ...
            .andExpect(jsonPath("$.[*].birimi").value(hasItem(DEFAULT_BIRIMI)));
    }
    ...
    void getApplicationUser() throws Exception {
        ...
        restApplicationUserMockMvc
            ...
            .andExpect(jsonPath("$.birimi").value(DEFAULT_BIRIMI));
    }
    ...
    void putNewApplicationUser() throws Exception {
        ...
        updatedApplicationUser.birimi(UPDATED_BIRIMI);
        ...
        ApplicationUser testApplicationUser = applicationUserList.get(applicationUserList.size() - 1);
        assertThat(testApplicationUser.getBirimi()).isEqualTo(UPDATED_BIRIMI);
    }
    ...
    void fullUpdateApplicationUserWithPatch() throws Exception {
        ...
        partialUpdatedApplicationUser.birimi(UPDATED_BIRIMI);
