...
import com.yesevi.egitimkadir.repository.KurumRepository;
...
class KurumResourceIT {
    ...
    public static Kurum createEntity(EntityManager em) {
        Kurum kurum = new Kurum().adi(DEFAULT_ADI).aciklama(DEFAULT_ACIKLAMA);
        return kurum;
    }
    ...
    public static Kurum createUpdatedEntity(EntityManager em) {
        Kurum kurum = new Kurum().adi(UPDATED_ADI).aciklama(UPDATED_ACIKLAMA);
        return kurum;
    }
    ...
    void putNewKurum() throws Exception {
        ...
        updatedKurum.adi(UPDATED_ADI).aciklama(UPDATED_ACIKLAMA);
    ...
    void partialUpdateKurumWithPatch() throws Exception {
        ...
        partialUpdatedKurum.adi(UPDATED_ADI);
    ...
    void fullUpdateKurumWithPatch() throws Exception {
        ...
        partialUpdatedKurum.adi(UPDATED_ADI).aciklama(UPDATED_ACIKLAMA);
