...
import com.yesevi.egitimkadir.repository.EgitimTuruRepository;
...
class EgitimTuruResourceIT {
    ...
    public static EgitimTuru createEntity(EntityManager em) {
        EgitimTuru egitimTuru = new EgitimTuru().adi(DEFAULT_ADI).aciklama(DEFAULT_ACIKLAMA);
        return egitimTuru;
    }
    ...
    public static EgitimTuru createUpdatedEntity(EntityManager em) {
        EgitimTuru egitimTuru = new EgitimTuru().adi(UPDATED_ADI).aciklama(UPDATED_ACIKLAMA);
        return egitimTuru;
    }
    ...
    void putNewEgitimTuru() throws Exception {
        ...
        updatedEgitimTuru.adi(UPDATED_ADI).aciklama(UPDATED_ACIKLAMA);
    ...
    void fullUpdateEgitimTuruWithPatch() throws Exception {
        ...
        partialUpdatedEgitimTuru.adi(UPDATED_ADI).aciklama(UPDATED_ACIKLAMA);
