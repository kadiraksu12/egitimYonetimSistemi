package com.yesevi.egitimkadir.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.yesevi.egitimkadir.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.yesevi.egitimkadir.repository.UserRepository.USERS_BY_EMAIL_CACHE);
