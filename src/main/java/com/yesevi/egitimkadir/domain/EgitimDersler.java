 ...
 */
@Entity
@Table(name = "egitim_dersler")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class EgitimDersler implements Serializable {
    ...
    public EgitimDersler id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public EgitimDersler egitim(Egitim egitim) {
    ...
    public EgitimDersler kullanici(ApplicationUser applicationUser) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EgitimDersler)) {
            return false;
        }
        return id != null && id.equals(((EgitimDersler) o).id);
    }
